...
static unsigned int* GDRAM;
static HWND hWnd;
static bl flag_btn_pressed_up       = false;
static bl flag_btn_pressed_down     = false;
static bl flag_btn_pressed_left     = false;
static bl flag_btn_pressed_right    = false;
static bl flag_btn_pressed_enter    = false;
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LGLISTSIMULATOR, szWindowClass, MAX_LOADSTRING);
    ...
    */
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LGLISTSIMULATOR));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LGLISTSIMULATOR));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LGLISTSIMULATOR);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT, 0, SCREEN_WIDTH * 2, SCREEN_HIGHT * 3, nullptr, nullptr, hInstance, nullptr);
